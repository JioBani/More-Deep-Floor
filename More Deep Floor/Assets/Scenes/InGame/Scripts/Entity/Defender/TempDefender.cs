...
namespace LNK.MoreDeepFloor.InGame.Entitys.Defenders
{
    ...
    /*public class TempDefender : Defender
    {
        ...
        private DefenderLifeState lifeState;
        ...
        {
            base.OnDie(killer);
            lifeState = DefenderLifeState.Die;
            defenderTargetCol.gameObject.SetActive(false);
            StartCoroutine(Revive());
        }
        
        public override void Init(EntityData entityData, int level)
        {
            base.Init(entityData, level);
        ...
        protected override void OnSpawn()
        {
            ...
            /*AddShield( id : "테스트쉴드" , 
                maxAmount:100 ,
                lateTime: 0,
                state: stateController.AddState(DefenderStateId.Test_TestShield));#1#
        }
        ...
        IEnumerator Revive()
        {
            ...
            lifeState = DefenderLifeState.Battle;
        }    
        ...
        {
            //TODO defenderManager.OnDefenderOff(this);
            placer.SetOff();
            poolable.SetOff();
        }
        ...
        {
            //Set
            lifeState = DefenderLifeState.Wait;
